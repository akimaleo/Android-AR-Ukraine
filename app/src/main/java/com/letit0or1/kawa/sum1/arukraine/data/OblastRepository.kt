...
//    fun getOblastList(): List<Oblast> {
//        return listOf(Oblast(R.string.lviv))
//    }
...
enum class Oblast(
    ...
    Crimea(R.string.crimea, R.raw.crimea, localPosition = Vector3(0.044f, 0f, 0.06f)),
    Dnipropetrovsk(
    ...
    Mykolaiv(R.string.mykolaiv, R.raw.mykolaiv, Vector3(0.9f, 1f, 0.9f), Vector3(0.002f, 0f, 0.02f)),
    ...
    Chernivtsi(R.string.chernivtsi, R.raw.chernivtsi, Vector3(0.7f, 0.1f, 0.7f), Vector3(-0.07f, 0f, 0.01f)),
    Khmelnitskyi(R.string.khmelnitskyi, R.raw.khmelnitskyi, localPosition = Vector3(-0.062f, 0f, -0.016f)),
    Lviv(R.string.lviv, R.raw.lviv, localPosition = Vector3(-0.1125f, 0f, -0.0225f)),
    InavoFrankisvk(R.string.ivanofrankivsk, R.raw.ivanofrankivsk, localPosition = Vector3(-0.095f, 0f, -0.0025f)),
    Ternopil(R.string.ternopil, R.raw.ternopil, Vector3(0.7f, 1f, 0.7f), Vector3(-0.084f, 0f, -0.0175f)),
    ...
    Zakarpatia(R.string.zakarpatia, R.raw.zakarpatia, localPosition = Vector3(-0.12f, 0f, -0.0075f)),
